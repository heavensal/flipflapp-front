const Map = () => {
  return (
    <svg
      ...
      className="transform h-20 z-20 rotate-25 -ms-4"
    >
      ...
      {/* PIN orange-rouge sur la zone verte */}
      <g id="pin" transform="">
        <path
          d="M12 5c-2.5 0-4.5 2-4.5 4.5 0 3.2 4.5 8 4.5 8s4.5-4.8 4.5-8C16.5 7 14.5 5 12 5z"
          fill="#e74c3c"
        />
